...
function getCookie2(){
    ...
    var ca = document.cookie.split(';');//armazena na variável ca um vetor ou matriz contendo a string do cookie, ignorando o ponto-e-v[irgula. A saída (eu acho) seria mais ou menos isso: c = ["contraste=contraste", expires="valor que corresponda à data e tempo que o cookie expira", path=/]
